...
use crate::config::highlighting::{SyntaxAndTheme, CLASS_STYLE};
...
impl<'config> InlineHighlighter<'config> {
    pub fn new(
        ...
        write_css_color(
            &mut color,
            theme.settings.foreground.unwrap_or(Color::BLACK),
        );
    ...
    pub fn highlight_line(&mut self, line: &str) -> String {
        ...
        .expect("Unable to get highlighted html");
    ...
    pub fn pre_style(&self) -> Option<String> {
        ...
        match self {
            ...
            Inlined(h) => {
                ...
                write_css_color(
                    &mut styles,
                    h.theme.settings.background.unwrap_or(Color::WHITE),
                );
                styles.push_str(";color:");
                write_css_color(
                    &mut styles,
                    h.theme.settings.foreground.unwrap_or(Color::BLACK),
                );
                styles.push(';');
                Some(styles)
            }
    ...
    pub fn mark_style(&self) -> Option<String> {
        ...
        match self {
            ...
            Inlined(h) => {
                ...
                write_css_color(
                    &mut styles,
                    h.theme.settings.line_highlight.unwrap_or(Color {
                        r: 255,
                        g: 255,
                        b: 0,
                        a: 0,
